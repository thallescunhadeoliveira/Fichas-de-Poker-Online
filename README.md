...
A aplicação deixa pré-selecionada a conta do Pote de Apostas como destino pois facilita a maioria das transações. Também deixa pré-definido para a quantia o valor da última transação, facilitando as transações de mesmo valor de uma mesma rodada de apostas. É possível selecionar qualquer conta para pagar ou receber, e escolher qualquer valor acima de 1. Colocando o valor da transação como 0, o jogador pode transferir todo o valor de uma conta para outra sem precisar digitar o valor específico que a conta tem, deixando a usabilidade mais fácil nos casos de transferir todo o valor do pote ao vencedor da rodada ou no caso do jogar dar um All-in apostando tudo que tem.
