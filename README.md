...
A aplicação deixa pré-selecionada a conta do Pote de Apostas como destino pois facilita a maioria das transações. Também deixa pré-definido para a quantia o valor da última transação, facilitando as transações de mesmo valor de uma mesma rodada de apostas. É possível selecionar qualquer conta para pagar ou receber, e escolher qualquer valor acima de 1.
